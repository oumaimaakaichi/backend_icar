...
<body class="d-flex">
    ...
    <div class="page-header">
        <h3><i class="fas fa-user-tie me-3"></i>Experts Management</h3>
    </div>
    <br/>
    ...
    <div class="search-section">
        <div class="search-controls d-flex align-items-center gap-3">
            ...
            <input type="text" id="searchInput" class="form-control" placeholder="Search for an expert...">
            <button class="btn btn-primary flex-shrink-0" data-bs-toggle="modal" data-bs-target="#addTechnicienModal">
                <i class="fas fa-plus me-2"></i>New Expert
            </button>
        </div>
    </div>
    ...
    @else
        <div class="no-data">
            ...
            <p>Start by adding your first expert</p>
        </div>
    @endif
</div>
...
<div class="modal fade" id="addTechnicienModal" tabindex="-1" aria-hidden="true">
    ...
    <script>
        ...
        // modifier les informations d'un expert
        document.addEventListener("DOMContentLoaded", function () {
