...
<body>
    ...
    <div class="sidebar" id="sidebar-menu">
        ...
        <h3>Entreprise Contractante Space</h3>
        <a href="statistiques" class="menu-link"><i class="fas fa-chart-bar"></i> Home</a>
        <a href="{{ route('entreprise.employeeEntreprise') }}" class="menu-link">
            <i class="fa-solid fa-users-between-lines me-2"></i>
            <span class="ms-1">Employees</span>
    ...
    <header class="main-header">
        <div class="user-info" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#userInfoModal">
            ...
            @auth('entreprise') {{-- Spécifiez explicitement la guard --}}
            <span class="user-name">
                {{ Auth::guard('entreprise')->user()->nom_entreprise }}
            </span>
        @else
