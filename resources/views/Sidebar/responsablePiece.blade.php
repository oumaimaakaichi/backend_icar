...
<body>
    ...
    <div class="sidebar" id="sidebar-menu">
       ...
       <a href="{{ route('reponsable_piece.demandes') }}" >
    <i class="fa-solid fa-screwdriver-wrench"></i> Demande de maintenance
</a>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <div class="menu-section">
                ...
                <a  href="{{ route('reponsable_piece.demandes') }}" class="menu-link">
