  ...
  @include('Sidebar.sidebarAtelier')
    ...
    <h3 class="main-title">Choose Your Service</h3>
            ...
            <div class="cards-container">
                <!-- Known Fault Card -->
                <div class="service-card known-fault" onclick="window.location.href='{{ route('atelierss.demandes-par-atelier') }}'">
    ...
    <i class="fas fa-arrow-right"></i>
                ...
                <!-- Unknown Fault Card -->
                <div class="service-card unknown-fault" onclick="window.location.href='{{ route('ateliers.demandeInconnu') }}'">
                    <div class="card-header">
                        <div class="card-icon-wrapper">
